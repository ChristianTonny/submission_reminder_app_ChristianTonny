...
Jane Smith, Shell Navigation, not submitted
Bob Johnson, Shell Navigation, submitted
Alice Brown, Shell Navigation, not submitted
Charlie Davis, Shell Navigation, submitted
EOF
...
chmod +x submission_reminder_app/app/reminder.sh submission_reminder_app/startup.sh
